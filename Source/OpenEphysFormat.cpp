...
OpenEphysFormat::OpenEphysFormat() : recordingNumber (0),
                                     experimentNumber (0),
                                     zeroBuffer (1, 50000),
...
{
    RecordEngineManager* man = new RecordEngineManager ("OPENEPHYS", "Open Ephys", &(engineFactory<OpenEphysFormat>) );
